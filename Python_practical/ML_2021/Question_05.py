"""
Consider the given dataset of average salary according to experience of a company. Manually create a .csv
file and store it. Show the sctter plot of the data. Now consider that you are a HR manager. A new candidate
comes to your company with 5 years of experience. With the help of linear regression find out the ideal salary
that you would offer to the employee. Also plot the regression lineon the scatter plot.
"""
...
df=pd.read_csv('ML_2021\com_sal.csv',header=None,encoding='utf-8')
