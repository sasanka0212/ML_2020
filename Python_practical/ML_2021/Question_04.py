"""
Create a function y=cos(x)+sin(x) and plot the function. Now from this function find discrete values 
of y for x values 0,1,2,3 and 4. Create a table for the x and y values. Now using linear regression find
values of y for appropriate x values. Plot the regressed values and the original function.
"""
