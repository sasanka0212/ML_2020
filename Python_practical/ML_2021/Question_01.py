"""
Create a 4 x 4 matrix and find its inverse. Add, subtract and multiply both the matrices. 
Colour plot all the resulting matrices considering each row as the values of different functions.
"""
import numpy as np
...
pro_x= X * inv_x
dif_x = X - inv_x
print("addition is : ", sum_x)
print("subtraction is : ", dif_x)
print("multiplication is : ", pro_x)